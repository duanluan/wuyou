...
import com.wuyou.system.domain.SysDept;
import com.wuyou.system.domain.SysRole;
import com.wuyou.system.domain.SysUser;
import com.wuyou.system.enums.SysDeptStatus;
import com.wuyou.system.service.ISysDeptService;
...
public class SysDeptController extends BaseController {
  ...
  public Result editSave(@Validated SysDept dept) {
    ...
    } else if (SysDeptStatus.DISABLE.getValue().equals(dept.getStatus()) && deptService.countNormalChildrenById(dept.getDeptId()) > 0) {
  ...
  public List<Ztree> treeDataExcludeChild(@PathVariable(value = "excludeId", required = false) Long excludeId) {
    ...
    return deptService.listTreeExcludeChild(dept);
  }
